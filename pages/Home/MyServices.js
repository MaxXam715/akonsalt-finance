...
export default function MyServices() {
    ...
    <div class="G-container">
        <div class="header">
            ...
            <span class="desc">Комплекс финансовых услуг: <br> от консалтинга и обучения, до интеграций решений стартапов в бизнес, а также оказываем профессиональную помощь на всех этапах сотрудничества</span>
        </div>
    ...
    const myServices = [
        ...
        {
            id: 3,
            title: "Финансовое консультирование компании",
        ...
        },
        {
            id: 5,
            title: "Страхование",
            desc: "Советник помогает клиентам определить необходимость страхования и подбрать подходящие страховые продукты, включая автомобильное страхование, медицинское страхование и др.",
