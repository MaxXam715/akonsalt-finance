...
export default function MyServices() {
    ...
    const myServices = [
        ...
        },
        {
            ...
            desc: "Консультант помогает предпринимателям развивать свои бизнесы, оценивает финансовые показатели, разрабатывает стратегии финансового управления и помогает в принятии стратегических решений",
            img: "/assets/img/services/service-3.jpg"
        },
        {
            id: 4,
            title: "Управление рисками",
            desc: "Консультант помогает клиентам определить и оценить риски, связанные с их финансовыми решениями, и разрабатывает стратегии управления рисками",
            img: "/assets/img/services/service-4.jpg"
        },
        {
            id: 5,
            title: "Страхование",
            desc: "Консультант помогает клиентам определить необходимость страхования и подбрать подходящие страховые продукты, включая автомобильное страхование, медицинское страхование и др.",
            img: "/assets/img/services/service-5.jpg"
        },
        {
            id: 6,
            title: "Кредитное консультирование",
            desc: "Консультант помогает клиентам разобраться в предложениях банков и выбрать наиболее подходящий кредитный продукт.",
