<script setup>
import FirstScreenVideo from "./FirstScreenVideo.vue";
</script>
  ...
  .G-container {
    ...
    .bg-gradient {
      ...
      &:before {
        ...
        height: 100%;
        opacity: 0.2;
        background: var(--Bg-gradient, linear-gradient(90deg, #06B6D4 0%, #1E40AF 100%));
      }
    }
    ...
    .row-container {
      ...
      .about-me {
        ...
        .title-heading {
          ...
          background: var(--Gray-gradient, linear-gradient(135deg, #FFF 0%, #9E9EA9 100%));
