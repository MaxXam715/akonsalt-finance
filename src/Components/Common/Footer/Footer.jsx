                ...
                <div className="g-container">
                    ...
                    <div className={style['wrapper-container']}>
                        <div className={style['left-col']}>
                            ...
                            <span className={style['text']}>{import.meta.env.VITE_EMAIL}</span>
                            <span className={style['text']}>{import.meta.env.VITE_ADDRESS}</span>
