            ...
            <div className="g-container">
                <div className={style['description-wrapper']}>
                    ...
                    <div className={style['right-col']}>
                        <p className={style['text-primary']}>Akonsalt Finance c 2018 г. сочетает академическую строгость, отраслевой опыт партнёров и передовые аналитические технологии.</p>
